...
path_site_im_2023 <- "Data/genie/Genie_SITE_IM_2023.txt"
path_site_im_2024_2025 <- "Data/genie/Genie_SITE_IM_2024_2025.txt"
...
path_dg_psnu_2023 <- "Data/Genie/Genie_PSNU_IM_2023.txt"
path_dg_psnu_2024_2025 <- "Data/Genie/Genie_PSNU_IM_2024_2025.txt"
...
dg_2023 <- read_delim(path_site_im_2023, # OK
                           delim = "\t", escape_double = FALSE, 
                           trim_ws = TRUE) %>% 
...
dg_2024_2025 <- read_delim(path_site_im_2024_2025, # OK
                      delim = "\t", escape_double = FALSE, 
                      trim_ws = TRUE) %>% 
...
setdiff(names(dg_2021), names(dg_2022))
setdiff(names(dg_2022), names(dg_2023))
setdiff(names(dg_2023), names(dg_2024_2025))
setdiff(names(dg_2024_2025), names(dg_2023))
setdiff(names(dg_2021), names(dg_2023_2024))

# BIND DATASETS & CLEAN MECH NAMES -----------------------------------------------------------


dg_2021_2025 <- bind_rows(dg_2021, dg_2022, dg_2023, dg_2024_2025) %>% 
...
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="siMZUtd2cJW" & dg_2021_2025$mech_name=="ARIEL"]<-"oX9C1fOEzSk"
dg_2021_2025$sitename[dg_2021_2025$orgunituid=="oX9C1fOEzSk" & dg_2021_2025$mech_name=="ARIEL"]<-"Cadeia Central PS"
dg_2021_2025$snu1[dg_2021_2025$orgunituid=="oX9C1fOEzSk" & dg_2021_2025$mech_name=="ARIEL"]<-"Maputo"
dg_2021_2025$psnu[dg_2021_2025$orgunituid=="oX9C1fOEzSk" & dg_2021_2025$mech_name=="ARIEL"]<-"Matola"

dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="siMZUtd2cJW" & dg_2021_2025$mech_name=="ICAP"]<-"oX9C1fOEzSk"
dg_2021_2025$sitename[dg_2021_2025$orgunituid=="oX9C1fOEzSk" & dg_2021_2025$mech_name=="ICAP"]<-"Cadeia Central PS"
dg_2021_2025$snu1[dg_2021_2025$orgunituid=="oX9C1fOEzSk" & dg_2021_2025$mech_name=="ICAP"]<-"Maputo"
dg_2021_2025$psnu[dg_2021_2025$orgunituid=="oX9C1fOEzSk" & dg_2021_2025$mech_name=="ICAP"]<-"Matola"


#Accounting for historical error in Chicavane and Chizavane: Converting EGPAF Chizavane to EGPAF Chicavane
dg_2021_2025$psnu[dg_2021_2025$orgunituid=="EjFYleP5G9K" & dg_2021_2025$mech_name=="EGPAF"]<-"Chonguene"
dg_2021_2025$sitename[dg_2021_2025$orgunituid=="EjFYleP5G9K" & dg_2021_2025$mech_name=="EGPAF"]<-"Chicavane CS"
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="EjFYleP5G9K" & dg_2021_2025$mech_name=="EGPAF"]<-"LqB6YZq9sG2"


#Accounting for historical error in Chicavane and Chizavane: Converting MISAU Chicavane to MISAU Chizavane
dg_2021_2025$psnu[dg_2021_2025$orgunituid=="LqB6YZq9sG2" & dg_2021_2025$mech_name=="MISAU"]<-"Mandlakaze"
dg_2021_2025$psnuuid[dg_2021_2025$orgunituid=="LqB6YZq9sG2" & dg_2021_2025$mech_name=="MISAU"]<-"VjJPal9jqUi"  # VERIFY THIS ADDRESSES ISSUE IDENTIFIED BY KIRSTIN
dg_2021_2025$sitename[dg_2021_2025$orgunituid=="LqB6YZq9sG2" & dg_2021_2025$mech_name=="MISAU"]<-"Chizavane CS"
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="LqB6YZq9sG2" & dg_2021_2025$mech_name=="MISAU"]<-"EjFYleP5G9K"

#Adjusting Sites Imported by PSM
dg_2021_2025$sitename[dg_2021_2025$orgunituid=="FWbL33AHdCC" & dg_2021_2025$mech_name=="PSM"]<-"Mandlakazi HR"
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="FWbL33AHdCC" & dg_2021_2025$mech_name=="PSM"]<-"xlYle4v5GZ8"

dg_2021_2025$sitename[dg_2021_2025$orgunituid=="qM7gh9auEmt" & dg_2021_2025$mech_name=="PSM"]<-"Massinga CS"
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="qM7gh9auEmt" & dg_2021_2025$mech_name=="PSM"]<-"wSW662GVwZP"

dg_2021_2025$sitename[dg_2021_2025$orgunituid=="W7CqwG3AuDh" & dg_2021_2025$mech_name=="PSM"]<-"Chicuque HR"
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="W7CqwG3AuDh" & dg_2021_2025$mech_name=="PSM"]<-"s28njgt1wYe"


#Setting up the HRSA/ ITECH at Alto Mae so it is not matched to CCS
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="jKg6rpNATKH" & dg_2021_2025$mech_name=="ITECH"]<-"jKg6rpNATKH_ITECH"

# Adjusting Inhamudima to Inhamuzia to align with new COP22 reporting 
dg_2021_2025$sitename[dg_2021_2025$orgunituid=="EslaBcDD5mZ"]<-"Inhamizua CS"
dg_2021_2025$orgunituid[dg_2021_2025$orgunituid=="EslaBcDD5mZ"]<-"wmXdfKNX0qT"
...
dg_psnu_2023 <- read_delim(path_dg_psnu_2023) %>% 
  select(-c(operatingunit,
            operatingunituid,
            country,
            snuprioritization,
...
dg_psnu_2024_2025 <- read_delim(path_dg_psnu_2024_2025) %>% 
  select(-c(operatingunit,
            operatingunituid,
            country,
            snuprioritization,
...
dg_psnu_2022_2025 <- bind_rows(dg_psnu_2022, dg_psnu_2023, dg_psnu_2024_2025) %>%
  mutate(mech_name = recode(mech_name, 
